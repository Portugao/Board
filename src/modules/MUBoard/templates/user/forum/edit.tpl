...
{form cssClass='z-form'}
    ...
    {if $mode ne 'create'}
        {include file='user/include_standardfields_edit.tpl' obj=$forum}
    {/if}
    {include file='user/category/include_selectEditOne.tpl' relItem=$forum aliasName='category' idPrefix='muboardCategory_Category'}
