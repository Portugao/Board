...
/**
 * The muboardFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_muboardFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('MUBoard_Form_Plugin_FormFrame', $params, $content);
