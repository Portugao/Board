{* purpose of this template: ranks view view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    {checkpermissionblock component='MUBoard::' instance='.*' level="ACCESS_ADD"}
        ...
        <a href="{modurl modname='MUBoard' type='admin' func='edit' ot='rank'}" title="{$createTitle}" class="z-icon-es-add">
            {$createTitle}
        </a>
    ...
    {if isset($showAllEntries) && $showAllEntries eq 1}
        ...
        <a href="{modurl modname='MUBoard' type='admin' func='view' ot='rank'}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
        {assign var='all' value=1}
    {else}
        {gt text='Show all entries' assign='linkTitle'}
        <a href="{modurl modname='MUBoard' type='admin' func='view' ot='rank' all=1}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
    {/if}
...
<table class="z-datatable">
    ...
    <tr>
        <th id="hname" scope="col" class="z-left">
            {sortlink __linktext='Name' sort='name' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='rank'}
        </th>
        <th id="hminpostings" scope="col" class="z-right">
            {sortlink __linktext='Min postings' sort='minPostings' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='rank'}
        </th>
        <th id="hmaxpostings" scope="col" class="z-right">
            {sortlink __linktext='Max postings' sort='maxPostings' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='rank'}
        </th>
        <th id="hnumberoficons" scope="col" class="z-right">
            {sortlink __linktext='Number of icons' sort='numberOfIcons' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='rank'}
        </th>
        <th id="huploadimage" scope="col" class="z-left">
            {sortlink __linktext='Upload image' sort='uploadImage' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='rank'}
        </th>
        <th id="hspecial" scope="col" class="z-center">
            {sortlink __linktext='Special' sort='special' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='rank'}
        </th>
