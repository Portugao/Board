{* purpose of this template: abos view view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    {checkpermissionblock component='MUBoard::' instance='.*' level="ACCESS_ADD"}
        ...
        <a href="{modurl modname='MUBoard' type='admin' func='edit' ot='abo'}" title="{$createTitle}" class="z-icon-es-add">
            {$createTitle}
        </a>
    ...
    {if isset($showAllEntries) && $showAllEntries eq 1}
        ...
        <a href="{modurl modname='MUBoard' type='admin' func='view' ot='abo'}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
        {assign var='all' value=1}
    {else}
        {gt text='Show all entries' assign='linkTitle'}
        <a href="{modurl modname='MUBoard' type='admin' func='view' ot='abo' all=1}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
    {/if}
...
<table class="z-datatable">
    ...
    <tr>
        <th id="huserid" scope="col" class="z-right">
            {sortlink __linktext='Userid' sort='userid' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='abo'}
        </th>
        <th id="hcatid" scope="col" class="z-right">
            {sortlink __linktext='Catid' sort='catid' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='abo'}
        </th>
        <th id="hforumid" scope="col" class="z-right">
            {sortlink __linktext='Forumid' sort='forumid' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='abo'}
        </th>
        <th id="hpostingid" scope="col" class="z-right">
            {sortlink __linktext='Postingid' sort='postingid' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='abo'}
        </th>
