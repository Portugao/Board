{* purpose of this template: abos display view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    <h3>{$templateTitle|notifyfilters:'muboard.filter_hooks.abos.filter'}</h3>
</div>
...
<dl id="MUBoard_body">
    ...
    {include file='admin/include_standardfields_display.tpl' obj=$abo}
