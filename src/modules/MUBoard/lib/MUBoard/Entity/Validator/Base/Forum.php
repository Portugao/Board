 ...
 *
 * This is the base validation class for forum entities.
 */
class MUBoard_Entity_Validator_Base_Forum extends MUBoard_Validator
{
     ...
     *
     * This method determines if there already exist forums with the same forum.
     *
