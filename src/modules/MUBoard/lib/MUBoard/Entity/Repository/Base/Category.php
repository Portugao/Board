 ...
 */
class MUBoard_Entity_Repository_Base_Category extends EntityRepository
{
    /**
     * @var string The default sorting field/expression.
     */
    protected $defaultSortingField = 'pos';
    ...
    public function truncateTable()
    {
        $query = $this->getEntityManager()
                 ->createQuery('DELETE MUBoard_Entity_Category');
        $query->execute();
    }
     ...
     *
     * @return array|MUBoard_Entity_Category retrieved data array or MUBoard_Entity_Category instance
     */
     ...
     * @param boolean $useJoins Whether to include joining related objects (optional) (default=true).
     *
     * @return ArrayCollection collection containing retrieved MUBoard_Entity_Category instances
     */
    ...
    public function selectSearch($fragment = '', $exclude = array(), $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.pos = \'' . $fragment . '\'';
    ...
    public function selectCount($where = '', $useJoins = true)
    {
        ...
        $qb->select($selection)
           ->from('MUBoard_Entity_Category', 'tbl');
     ...
     * @param int    $excludeid  Id of categories to exclude (optional).
