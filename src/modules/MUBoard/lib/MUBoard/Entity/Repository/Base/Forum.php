 ...
 */
class MUBoard_Entity_Repository_Base_Forum extends EntityRepository
{
    /**
    ...
    public function truncateTable()
    {
        $query = $this->getEntityManager()
                 ->createQuery('DELETE MUBoard_Entity_Forum');
        $query->execute();
    }
     ...
     *
     * @return array|MUBoard_Entity_Forum retrieved data array or MUBoard_Entity_Forum instance
     */
     ...
     * @param boolean $useJoins Whether to include joining related objects (optional) (default=true).
     *
     * @return ArrayCollection collection containing retrieved MUBoard_Entity_Forum instances
     */
     ...
     * @param int    $excludeid  Id of forums to exclude (optional).
