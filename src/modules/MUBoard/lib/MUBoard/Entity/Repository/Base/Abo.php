 ...
 */
class MUBoard_Entity_Repository_Base_Abo extends EntityRepository
{
    /**
    ...
    public function truncateTable()
    {
        $query = $this->getEntityManager()
                 ->createQuery('DELETE MUBoard_Entity_Abo');
        $query->execute();
    }
     ...
     *
     * @return array|MUBoard_Entity_Abo retrieved data array or MUBoard_Entity_Abo instance
     */
     ...
     * @param boolean $useJoins Whether to include joining related objects (optional) (default=true).
     *
     * @return ArrayCollection collection containing retrieved MUBoard_Entity_Abo instances
     */
    ...
    public function selectSearch($fragment = '', $exclude = array(), $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.catid = \'' . $fragment . '\'';
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.forumid = \'' . $fragment . '\'';
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.postingid = \'' . $fragment . '\'';
     ...
     * @param int    $excludeid  Id of abos to exclude (optional).
