 ...
 */
class MUBoard_Controller_Base_Admin extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view($args)
    {
        ...
        if ($tpl == 'tree') {
            ...
            return MUBoard_Util_View::processTemplate($this->view, 'admin', $objectType, 'view', $args);
        }
    ...
    public function display($args)
    {
        ...
        // fetch and return the appropriate template
        return MUBoard_Util_View::processTemplate($this->view, 'admin', $objectType, 'display', $args);
    }
    ...
    public function edit($args)
    {
        ...
        $handlerClass = 'MUBoard_Form_Handler_Admin_' . ucfirst($objectType) . '_Edit';
