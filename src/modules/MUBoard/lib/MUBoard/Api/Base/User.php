 ...
 */
class MUBoard_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url($this->name, 'user', 'view', array('ot' => 'abo')),
                'text'  => $this->__('Abos'),
                'title' => $this->__('Abo list'));
        }
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
        ...
        if (SecurityUtil::checkPermission($this->name . '::', '::', ACCESS_READ)) {
            $links[] = array('url'   => ModUtil::url($this->name, 'user', 'view', array('ot' => 'rank')),
                'text'  => $this->__('Ranks'),
