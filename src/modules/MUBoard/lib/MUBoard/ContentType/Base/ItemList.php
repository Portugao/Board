 ...
 */
class MUBoard_ContentType_Base_ItemList extends Content_AbstractContentType
{
    private $objectType;
    private $sorting;
    private $amount;
    ...
    public function getTitle()
    {
        ...
        return __('MUBoard items', $dom);
    }

    public function getDescription()
    {
        $dom = ZLanguage::getModuleDomain('MUBoard');
        return __('Display MUBoard items.', $dom);
    }
    ...
    {
        return array('objectType' => 'category',
            'sorting'    => 'default',
            'amount'     => 1,
    ...
    {
        $dom = ZLanguage::getModuleDomain('MUBoard');
        array_push($this->view->plugins_dir, 'modules/MUBoard/templates/plugins');
    }
}
