 ...
 */
class MUBoard_Form_Handler_User_Category_Base_Edit extends MUBoard_Form_Handler_User_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'user', 'display', array('ot' => 'category', 'id' => $this->idValues['id']));
        }
        return $url;
    }
