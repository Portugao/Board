 ...
 */
class MUBoard_Form_Handler_Admin_Rank_Base_Edit extends MUBoard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'edit') {
            ...
            if ($this->hasTemplateId !== true) {
                $entity['user'] = $this->retrieveRelatedObjects('user', 'user', true);
            }
        }
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'rank', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    public function reassignRelatedObjects()
    {
        ...
        // reassign the users eventually chosen by the user
        $selectedRelations['user'] = $this->retrieveRelatedObjects('user', 'muboardUser_UserItemList', true, 'POST');
