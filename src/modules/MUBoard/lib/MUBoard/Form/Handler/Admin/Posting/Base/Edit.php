 ...
 */
class MUBoard_Form_Handler_Admin_Posting_Base_Edit extends MUBoard_Form_Handler_Admin_Edit
{
    /**
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'posting', 'id' => $this->idValues['id']));
        }
        return $url;
    }
