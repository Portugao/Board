 ...
 */
class MUBoard_Form_Handler_Admin_Abo_Base_Edit extends MUBoard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeLowerMultiple = 'abos';
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'abo', 'id' => $this->idValues['id']));
        }
        return $url;
    }
