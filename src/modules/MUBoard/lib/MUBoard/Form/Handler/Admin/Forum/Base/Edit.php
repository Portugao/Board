 ...
 */
class MUBoard_Form_Handler_Admin_Forum_Base_Edit extends MUBoard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function preInitialize()
    {
        ...
        $this->objectTypeLowerMultiple = 'forums';
    ...
    protected function getRedirectCodes()
    {
        ...
        $codes[] = 'adminViewCategory';
        // admin display page of treated category
        $codes[] = 'adminDisplayCategory';
        // user list of categories
        $codes[] = 'userViewCategory';
        // user display page of treated category
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'forum', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    public function fetchInputData(Zikula_Form_View $view, &$args)
    {
        ...
        $entityData['Category'] = ((isset($selectedRelations['category'])) ? $selectedRelations['category'] : $this->retrieveRelatedObjects('category', 'muboardCategory_CategoryItemList', false, 'POST'));
        ...
        switch ($this->returnTo) {
            ...
            case 'adminDisplayCategory':
                if (!empty($this->category)) {
                    return ModUtil::url($this->name, 'admin', 'display', array('ot' => 'category', 'id' => $this->category));
                }
                return $this->getDefaultReturnUrl($args, $obj);
            case 'userViewCategory':
                return ModUtil::url($this->name, 'user', 'view',
                    array('ot' => 'category'));
            case 'userDisplayCategory':
                if (!empty($this->category)) {
                    return ModUtil::url($this->name, 'user', 'display', array('ot' => 'category', 'id' => $this->category));
                }
                return $this->getDefaultReturnUrl($args, $obj);
            default:
                return $this->getDefaultReturnUrl($args, $obj);
    ...
    public function reassignRelatedObjects()
    {
        ...
        // reassign the category eventually chosen by the user
        $selectedRelations['category'] = $this->retrieveRelatedObjects('category', 'muboardCategory_CategoryItemList', false, 'POST');
        // reassign the postings eventually chosen by the user
        $selectedRelations['posting'] = $this->retrieveRelatedObjects('posting', 'muboardPosting_PostingItemList', true, 'POST');
