 ...
 */
class MUBoard_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('MUBoard:ItemListBlock:', 'Block title::');
    }
    ...
    public function info()
    {
        ...
        if (!ModUtil::available('MUBoard')) {
            $requirementMessage .= $this->__('Notice: This block will not be displayed until you activate the MUBoard module.');
        }

        return array('module'          => 'MUBoard',
            'text_type'       => $this->__('Item list'),
            'text_type_long'  => $this->__('Show a list of MUBoard items based on different criteria.'),
            'allow_multiple'  => true,
            'form_content'    => false,
            'form_refresh'    => false,
            'show_preview'    => true,
