...
abstract class AbstractPostingController extends AbstractController
{
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        $sortableColumns->addColumns([
            ...
            new Column('secondFile'),
            new Column('thirdFile'),
            new Column('parent'),
            new Column('forum'),
    ...
    protected function deleteInternal(Request $request, PostingEntity $posting, $isAdmin = false)
    {
        ...
        $form = $this->createForm('Zikula\Bundle\FormExtensionBundle\Form\Type\DeletionType', $posting);
