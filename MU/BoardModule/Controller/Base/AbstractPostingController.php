...
abstract class AbstractPostingController extends AbstractController
{
     ...
     *
     * @param Request $request Current request instance
     * @param integer $id Identifier of treated posting instance
     *
     * @return Response Output
     *
     * @throws AccessDeniedException Thrown if the user doesn't have required permissions
     * @throws NotFoundHttpException Thrown if posting to be displayed isn't found
     */
    public function adminDisplayAction(Request $request, $id)
    {
        $posting = $this->get('mu_board_module.entity_factory')->getRepository('posting')->selectById($id);
        if (null === $posting) {
            throw new NotFoundHttpException($this->__('No such posting found.'));
        }
    ...
    protected function displayInternal(Request $request, PostingEntity $posting, $isAdmin = false)
    {
        ...
        $controllerHelper = $this->get('mu_board_module.controller_helper');
        $templateParameters = $controllerHelper->processDisplayActionParameters($objectType, $templateParameters, $posting->supportsHookSubscribers());
     ...
     *
     * @throws AccessDeniedException Thrown if the user doesn't have required permissions
     * @throws NotFoundHttpException Thrown if posting to be deleted isn't found
     * @throws RuntimeException      Thrown if another critical error occurs (e.g. workflow actions not available)
     */
