...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/MU/BoardModule/Resources/public/js/MUBoardModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'muboardmodule',
                'path' => 'modules/MU/BoardModule/Resources/scribite/TinyMce/muboardmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'muboardmodule',
                'path' => 'modules/MU/BoardModule/Resources/scribite/CKEditor/muboardmodule/',
                'file' => 'plugin.js',
