...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from board app';
     *     $event->getRequest()->attributes->set('MUBoardModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUBoardModule_test');`
     *     now `$testMessage` should be: `'Hello from board app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('board App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
