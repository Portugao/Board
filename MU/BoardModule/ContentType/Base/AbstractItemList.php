...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('MUBoardModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of MUBoardModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('mu_board_module.controller_helper');
    ...
    {
        $repository = $this->container->get('mu_board_module.entity_factory')->getRepository($this->objectType);
        $permissionApi = $this->container->get('zikula_permissions_module.api.permission');
    
        // create query
        $orderBy = $this->container->get('mu_board_module.model_helper')->resolveSortParameter($this->objectType, $this->sorting);
        ...
        $templateParameters = $this->container->get('mu_board_module.controller_helper')->addTemplateParameters($this->objectType, $templateParameters, 'contentType', []);
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'MUBoardModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/MU/BoardModule/Resources/views/plugins');
    }
