...
use MU\BoardModule\ContentType\Form\Type\ItemType as FormType;
...
abstract class AbstractItemType extends AbstractContentType
{
    ...
    {
        return $this->translator->__('Board detail', 'muboardmodule');
    }
    ...
    {
        return $this->translator->__('Display or link a single board object.', 'muboardmodule');
    }
    ...
    public function displayView()
    {
        ...
        $controllerReference = new ControllerReference('MUBoardModule:External:display', $this->getDisplayArguments(), ['template' => $this->data['customTemplate']]);
    ...
    {
        if (null === $this->data['id'] || empty($this->data['id']) || empty($this->data['displayMode'])) {
            return $this->translator->__('No item selected.', 'muboardmodule');
        }
