...
/**
 * Category finder form type base class.
 */
abstract class AbstractCategoryFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * CategoryFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the category') => 1,
                $this->__('Absolute url to the category') => 2,
                $this->__('ID of category') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'muboardmodule_categoryfinder';
    }
