...
/**
 * Rank finder form type base class.
 */
abstract class AbstractRankFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * RankFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the rank') => 1,
                $this->__('Absolute url to the rank') => 2,
                $this->__('ID of rank') => 3,
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' => [
                    $this->__('Name') => 'name',
                    $this->__('Min postings') => 'minPostings',
                    $this->__('Max postings') => 'maxPostings',
                    $this->__('Number of icons') => 'numberOfIcons',
                    $this->__('Upload image') => 'uploadImage',
                    $this->__('Special') => 'special',
    ...
    {
        return 'muboardmodule_rankfinder';
    }
