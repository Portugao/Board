...
/**
 * Forum finder form type base class.
 */
abstract class AbstractForumFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * ForumFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the forum') => 1,
                $this->__('Absolute url to the forum') => 2,
                $this->__('ID of forum') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'muboardmodule_forumfinder';
    }
