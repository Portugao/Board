...
/**
 * Posting finder form type base class.
 */
abstract class AbstractPostingFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * PostingFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the posting') => 1,
                $this->__('Absolute url to the posting') => 2,
                $this->__('ID of posting') => 3,
    ...
    {
        return 'muboardmodule_postingfinder';
    }
