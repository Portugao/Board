...
/**
 * Abo finder form type base class.
 */
abstract class AbstractAboFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * AboFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the abo') => 1,
        ...
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' => [
                    ...
                    $this->__('Catid') => 'catid',
                    $this->__('Forumid') => 'forumid',
                    $this->__('Postingid') => 'postingid',
    ...
    {
        return 'muboardmodule_abofinder';
    }
