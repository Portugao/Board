...
/**
 * Abo quick navigation form type base class.
 */
abstract class AbstractAboQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        $listEntries = $this->listHelper->getEntries('abo', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muboardmodule_aboquicknav';
    }
}
