...
/**
 * Rank quick navigation form type base class.
 */
abstract class AbstractRankQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        $listEntries = $this->listHelper->getEntries('rank', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        $builder->add('special', ChoiceType::class, [
    ...
    {
        return 'muboardmodule_rankquicknav';
    }
}
