...
/**
 * Forum quick navigation form type base class.
 */
abstract class AbstractForumQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('forum', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muboardmodule_forumquicknav';
    }
}
