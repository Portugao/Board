...
/**
 * Category quick navigation form type base class.
 */
abstract class AbstractCategoryQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * CategoryQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('category', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muboardmodule_categoryquicknav';
    }
}
