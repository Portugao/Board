...
namespace MU\BoardModule\Form\Handler\Category\Base;

use MU\BoardModule\Form\Handler\Common\EditHandler;
use MU\BoardModule\Form\Type\CategoryType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if ('create' == $this->templateParameters['mode']) {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->requestStack->getCurrentRequest()->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the category yet as other items are required which must be created before!'));
    ...
    {
        return $this->formFactory->create(CategoryType::class, $this->entityRef, $this->getFormOptions());
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of category area
        $codes[] = 'userIndex';
        // admin index page of category area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated category
        $codes[] = 'userDisplay';
        // admin detail page of treated category
        $codes[] = 'adminDisplay';
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUBoardModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'category', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
