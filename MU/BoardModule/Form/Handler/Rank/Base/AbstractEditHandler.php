...
namespace MU\BoardModule\Form\Handler\Rank\Base;

use MU\BoardModule\Form\Handler\Common\EditHandler;
use MU\BoardModule\Form\Type\RankType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    {
        return $this->formFactory->create(RankType::class, $this->entityRef, $this->getFormOptions());
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of rank area
        $codes[] = 'userIndex';
        // admin index page of rank area
        $codes[] = 'adminIndex';
        // user list of ranks
        $codes[] = 'userView';
        // admin list of ranks
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated rank
        $codes[] = 'userDisplay';
        // admin detail page of treated rank
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultMessage(array $args = [], $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                ...
                break;
            case 'delete':
                $message = $this->__('Done! Rank deleted.');
                break;
            default:
                $message = $this->__('Done! Rank updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUBoardModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'rank', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
