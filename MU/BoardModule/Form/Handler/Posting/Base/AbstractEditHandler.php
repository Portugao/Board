...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the posting yet as other items are required which must be created before!'));
    ...
    protected function initRelationPresets()
    {
        ...
        $this->relationPresets['parent'] = $this->request->get('parent', '');
        ...
        // editable relation, we store the id and assign it now to show it in UI
        $this->relationPresets['forum'] = $this->request->get('forum', '');
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create(PostingType::class, $this->entityRef, $options);
    }
