...
namespace MU\BoardModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUBoardModule:js/MUBoardModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUBoardModule:js/MUBoardModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUBoardModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        $view = Zikula_View::getInstance('MUBoardModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUBoardModule_objecttype', 'category');
