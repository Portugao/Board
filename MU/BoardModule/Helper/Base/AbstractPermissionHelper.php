...
abstract class AbstractPermissionHelper implements ContainerAwareInterface
{
    ...
    public function hasEntityPermission($entity, $permissionLevel, $userId = null)
    {
        ...
        return $this->permissionApi->hasPermission('MUBoardModule:' . ucfirst($objectType) . ':', $instance, $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUBoardModule:' . ucfirst($objectType) . ':', '::', $permissionLevel, $userId);
    }
    ...
    {
        return $this->permissionApi->hasPermission('MUBoardModule::', '::', $permissionLevel, $userId);
    }
