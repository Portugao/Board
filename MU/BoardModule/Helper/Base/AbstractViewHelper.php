...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func, $isAdmin = false)
    {
        ...
        $template = '@MUBoardModule/' . ucfirst($type) . '/' . ($isAdmin ? 'Admin/' : '') . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('MUBoardModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@MUBoardModule/includePdfHeader.html.twig') . $output . '</body></html>';
