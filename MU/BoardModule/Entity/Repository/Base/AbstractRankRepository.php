 ...
 *
 * This is the base repository class for rank entities.
 */
abstract class AbstractRankRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\BoardModule\Entity\RankEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUBoardModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'ranks', 'userid' => $userId];
     ...
     *
     * @return array|rankEntity Retrieved data array or rankEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved rankEntity instances
     */
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('rank', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('rank', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of ranks to exclude (optional)
     *
