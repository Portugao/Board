 ...
 *
 * This is the base repository class for posting entities.
 */
abstract class AbstractPostingRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\BoardModule\Entity\PostingEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'parent_id';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUBoardModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'postings', 'userid' => $userId];
     ...
     *
     * @return array|postingEntity Retrieved data array or postingEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved postingEntity instances
     */
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('posting', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('posting', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of postings to exclude (optional)
     *
    ...
    {
        $selection = ', tblParent, tblForum, tblChildren';
