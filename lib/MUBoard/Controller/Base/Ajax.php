 ...
 */
class MUBoard_Controller_Base_Ajax extends Zikula_Controller_AbstractAjax
{
    ...
    public function toggleFlag()
    {
        ...
        if ($id == 0 || ($objectType != 'posting' && $objectType != 'rank') || ($objectType == 'posting' && !in_array($field, array('state'))) || ($objectType == 'rank' && !in_array($field, array('special')))) {
