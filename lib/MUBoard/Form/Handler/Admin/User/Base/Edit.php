 ...
 */
class MUBoard_Form_Handler_Admin_User_Base_Edit extends MUBoard_Form_Handler_Admin_Edit
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'edit') {
            ...
            if ($this->hasTemplateId !== true) {
                $entity['rank'] = $this->retrieveRelatedObjects('rank', 'rank', false);
            }
        }
    ...
    protected function getRedirectCodes()
    {
        ...
        // admin list of ranks
        $codes[] = 'adminViewRank';
        // admin display page of treated rank
        $codes[] = 'adminDisplayRank';
        // user list of ranks
        $codes[] = 'userViewRank';
        // user display page of treated rank
    ...
    protected function getDefaultReturnUrl($args, $obj)
    {
        ...
        if ($args['commandName'] != 'delete' && !($this->mode == 'create' && $args['commandName'] == 'cancel')) {
            ...
            $url = ModUtil::url($this->name, 'admin', 'display', array('ot' => 'user', 'id' => $this->idValues['id']));
        }
        return $url;
    }
    ...
    public function fetchInputData(Zikula_Form_View $view, &$args)
    {
        ...
        $entityData['Rank'] = ((isset($selectedRelations['rank'])) ? $selectedRelations['rank'] : $this->retrieveRelatedObjects('rank', 'muboardRank_RankItemList', false, 'POST'));
    ...
    protected function getRedirectUrl($args, $obj, $repeatCreateAction = false)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'adminDisplayRank':
                if (!empty($this->rank)) {
                    return ModUtil::url($this->name, 'admin', 'display', array('ot' => 'rank', 'id' => $this->rank));
                }
                return $this->getDefaultReturnUrl($args, $obj);
            case 'userViewRank':
                return ModUtil::url($this->name, 'user', 'view',
            ...
            case 'userDisplayRank':
                if (!empty($this->rank)) {
                    return ModUtil::url($this->name, 'user', 'display', array('ot' => 'rank', 'id' => $this->rank));
                }
                return $this->getDefaultReturnUrl($args, $obj);
            default:
                return $this->getDefaultReturnUrl($args, $obj);
    ...
    public function reassignRelatedObjects()
    {
        ...
        // reassign the rank eventually chosen by the user
        $selectedRelations['rank'] = $this->retrieveRelatedObjects('rank', 'muboardRank_RankItemList', false, 'POST');
