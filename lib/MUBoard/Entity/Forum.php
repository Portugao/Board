 ...
 * @ORM\Entity(repositoryClass="MUBoard_Entity_Repository_Forum")
 * @ORM\Table(name="muboard_forum")
...
class MUBoard_Entity_Forum extends MUBoard_Entity_Base_Forum
{
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentType == 'user') {
            ...
            if ($currentFunc == 'display') {
                   $this->_actions[] = array(
                        'url' => array('type' => 'user', 'func' => 'edit', 'arguments' => array('ot' => 'posting', 'forum' => $this['id'])),
                        'icon' => 'back',
                        'linkTitle' => __('Create new posting', $dom),
                        'linkText' => __('Create new posting', $dom)
                    );
                    $this->_actions[] = array(
     ...
     *
     * @ORM\PostLoad
     * @see MUBoard_Entity_Base_Forum::performPostLoadCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PrePersist
     * @see MUBoard_Entity_Base_Forum::performPrePersistCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PostPersist
     * @see MUBoard_Entity_Base_Forum::performPostPersistCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PreRemove
     * @see MUBoard_Entity_Base_Forum::performPreRemoveCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PostRemove
     * @see MUBoard_Entity_Base_Forum::performPostRemoveCallback()
     * @return void
     */
     ...
     *
     * @ORM\PreUpdate
     * @see MUBoard_Entity_Base_Forum::performPreUpdateCallback()
     * @return void.
     */
     ...
     *
     * @ORM\PostUpdate
     * @see MUBoard_Entity_Base_Forum::performPostUpdateCallback()
     * @return void.
     */
     ...
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * @see MUBoard_Entity_Base_Forum::performPreSaveCallback()
     * @return void.
     */
     ...
     * @ORM\PostPersist
     * @ORM\PostUpdate
     * @see MUBoard_Entity_Base_Forum::performPostSaveCallback()
     * @return void.
     */
