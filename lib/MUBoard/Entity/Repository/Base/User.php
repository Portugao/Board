 ...
 */
class MUBoard_Entity_Repository_Base_User extends EntityRepository
{
    /**
    ...
    public function truncateTable()
    {
        $query = $this->getEntityManager()
                 ->createQuery('DELETE MUBoard_Entity_User');
        $query->execute();
    }
     ...
     *
     * @return array|MUBoard_Entity_User retrieved data array or MUBoard_Entity_User instance
     */
     ...
     * @param boolean $useJoins Whether to include joining related objects (optional) (default=true).
     *
     * @return ArrayCollection collection containing retrieved MUBoard_Entity_User instances
     */
    ...
    public function selectSearch($fragment = '', $exclude = array(), $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.numberPostings = \'' . $fragment . '\'';
        $whereSub .= ((!empty($whereSub)) ? ' OR ' : '') . 'tbl.lastVisit = \'' . $fragment . '\'';
     ...
     * @param int    $excludeid  Id of users to exclude (optional).
