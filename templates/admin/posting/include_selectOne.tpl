...
<fieldset>
    ...
    <div class="muboardRelationLeftSide">
        {if isset($userSelection.$aliasName) && $userSelection.$aliasName ne ''}
            ...
            {include file='admin/posting/include_selectItemListOne.tpl' item=$userSelection.$aliasName}
        {elseif $mode ne 'create' || isset($relItem.$aliasName)}
            {include file='admin/posting/include_selectItemListOne.tpl' item=$relItem.$aliasName}
        {else}
            {include file='admin/posting/include_selectItemListOne.tpl'}
        {/if}
    </div>
    <br style="clear: both" />
    </div>
