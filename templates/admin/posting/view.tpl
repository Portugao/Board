{* purpose of this template: postings view view in admin area *}
...
<div class="z-admin-content-pagetitle">
    ...
    {checkpermissionblock component='MUBoard::' instance='.*' level="ACCESS_ADD"}
        ...
        <a href="{modurl modname='MUBoard' type='admin' func='edit' ot='posting'}" title="{$createTitle}" class="z-icon-es-add">
            {$createTitle}
        </a>
    ...
    {if isset($showAllEntries) && $showAllEntries eq 1}
        ...
        <a href="{modurl modname='MUBoard' type='admin' func='view' ot='posting'}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
        {assign var='all' value=1}
    {else}
        {gt text='Show all entries' assign='linkTitle'}
        <a href="{modurl modname='MUBoard' type='admin' func='view' ot='posting' all=1}" title="{$linkTitle}" class="z-icon-es-view">
            {$linkTitle}
        </a>
    {/if}
...
<table class="z-datatable">
    ...
    <tr>
        <th id="hparent_id" scope="col" class="z-right">
            {sortlink __linktext='Parent_id' sort='parent_id' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="htitle" scope="col" class="z-left">
            {sortlink __linktext='Title' sort='title' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="htext" scope="col" class="z-left">
            {sortlink __linktext='Text' sort='text' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hinvocations" scope="col" class="z-right">
            {sortlink __linktext='Invocations' sort='invocations' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hfirstimage" scope="col" class="z-left">
            {sortlink __linktext='First image' sort='firstImage' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hsecondimage" scope="col" class="z-left">
            {sortlink __linktext='Second image' sort='secondImage' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hthirdimage" scope="col" class="z-left">
            {sortlink __linktext='Third image' sort='thirdImage' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hfirstfile" scope="col" class="z-left">
            {sortlink __linktext='First file' sort='firstFile' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hsecondfile" scope="col" class="z-left">
            {sortlink __linktext='Second file' sort='secondFile' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hthirdfile" scope="col" class="z-left">
            {sortlink __linktext='Third file' sort='thirdFile' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hparent" scope="col" class="z-left">
            {sortlink __linktext='Parent' sort='parent' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
        <th id="hforum" scope="col" class="z-left">
            {sortlink __linktext='Forum' sort='forum' currentsort=$sort sortdir=$sdir all=$all modname='MUBoard' type='admin' func='view' ot='posting'}
        </th>
    ...
    <tr class="{cycle values='z-odd, z-even'}">
        ...
        <td headers="hparent" class="z-left">
            {if isset($posting.Parent) && $posting.Parent ne null}
                ...
                <a id="postingItem{$posting.id}_rel_{$posting.Parent.id}Display" href="{modurl modname='MUBoard' type='admin' func='display' ot='posting' id=$posting.Parent.id theme='Printer'}" title="{gt text='Open quick view window'}" style="display: none">
        ...
        <td headers="hforum" class="z-left">
            {if isset($posting.Forum) && $posting.Forum ne null}
                ...
                <a id="forumItem{$posting.id}_rel_{$posting.Forum.id}Display" href="{modurl modname='MUBoard' type='admin' func='display' ot='forum' id=$posting.Forum.id theme='Printer'}" title="{gt text='Open quick view window'}" style="display: none">
                    {icon type='view' size='extrasmall' __alt='Quick view'}
                </a>
                <script type="text/javascript" charset="utf-8">
                /* <![CDATA[ */
