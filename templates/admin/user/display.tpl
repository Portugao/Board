...
<dl id="MUBoard_body">
    ...
    {if isset($user.Rank) && $user.Rank ne null}
      {if !isset($smarty.get.theme) || $smarty.get.theme ne 'Printer'}
        ...
        <a id="rankItem{$user.Rank.id}Display" href="{modurl modname='MUBoard' type='admin' func='display' ot='rank' id=$user.Rank.id theme='Printer'}" title="{gt text='Open quick view window'}" style="display: none">
